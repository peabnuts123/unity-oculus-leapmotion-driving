...
{
    private static readonly string videoPlayerFileName = "Assets/Plugins/Oculus/SampleFramework/Core/Video/Plugins/Android/java/com/oculus/videoplayer/NativeVideoPlayer.java";
    private static readonly string disabledPlayerFileName = videoPlayerFileName + ".DISABLED";

    private static readonly string gradleSourceSetPath = "$projectDir/../../Assets/Plugins/Oculus/SampleFramework/Core/Video/Plugins/Android/java";

    private static readonly string audio360PluginPath = "Assets/Plugins/Oculus/SampleFramework/Core/Video/Plugins/Android/Audio360/audio360.aar";
    private static readonly string audio360Exo28PluginPath = "Assets/Plugins/Oculus/SampleFramework/Core/Video/Plugins/Android/Audio360/audio360-exo28.aar";
